...
// 	fmt.Printf("This is the user we want: %v\n", user)
...
// 		req.Header.Set("Authorization", "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdXRob3JpemVkIjp0cnVlLCJleHAiOjE1NjY3NDQ3MzAsInVzZXJfaWQiOjF9.4-eDUYoUC4120XB5Zf2QMrBlgiIme8-KTHEKpJLmuuU")
